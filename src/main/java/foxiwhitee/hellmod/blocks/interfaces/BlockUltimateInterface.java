...
public class BlockUltimateInterface extends BlockHybridInterface {
    ...
    public void registerBlockIconsSpecial(IIconRegister register) {
        this.icons[0] = register.registerIcon(HellCore.MODID + ":ae2/ultimate_interface");
        this.icons[1] = register.registerIcon(HellCore.MODID + ":ae2/ultimate_interface_alternate");
        this.icons[2] = register.registerIcon(HellCore.MODID + ":ae2/ultimate_interface_alternate_arrow");
    }
}
