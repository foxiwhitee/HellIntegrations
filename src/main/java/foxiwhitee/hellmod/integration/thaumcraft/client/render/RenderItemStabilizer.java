...
public class RenderItemStabilizer implements IItemRenderer {
    ...
    private final IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation(HellCore.MODID, "models/stabilizer.obj"));
    ...
    protected ResourceLocation getTexture() {
        return new ResourceLocation(HellCore.MODID, "textures/blocks/stabilizer.png");
    }
}
