...
public class ChaoticPickaxe extends CMiningTool implements IInventoryTool, IRenderTweak, ICustomUpgradableItem {
    private String name;
    public ChaoticPickaxe(Item.ToolMaterial material, String name) {
        super(material);
        this.name = name;
