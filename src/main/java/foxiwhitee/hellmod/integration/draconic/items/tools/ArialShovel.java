...
public class ArialShovel extends CMiningTool implements IInventoryTool, IRenderTweak, ICustomUpgradableItem {
    private String name;
    public ArialShovel(ToolMaterial material, String name) {
        super(material);
        this.name = name;
