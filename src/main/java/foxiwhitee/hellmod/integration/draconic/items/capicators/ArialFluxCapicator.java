...
public class ArialFluxCapicator extends RFItemBase implements ICustomUpgradableItem {
    IIcon[] icons = new IIcon[2];
    private String name;
    public ArialFluxCapicator(String name) {
        this.name = name;
    ...
    public void getSubItems(Item item, CreativeTabs tab, List list) {
        ...
        list.add(ItemNBTHelper.setLong(new ItemStack(item, 1, 0), "Energy", HellConfig.arialCapacitorBaseStorage));
    }
    ...
    public long getCapacity(ItemStack stack) {
        ...
        return HellConfig.arialCapacitorBaseStorage + points * HellConfig.arialCapacitorStoragePerUpgrade;
    }

    public int getMaxExtract(ItemStack stack) {
        return HellConfig.arialCapacitorMaxExtract;
    }

    public int getMaxReceive(ItemStack stack) {
        return HellConfig.arialCapacitorMaxReceive;
    }
        ...
        if (entity instanceof EntityPlayer) {
            ...
            if (mode == 1 || mode == 3)
                for (int i = 0; i < 9; i++) {
                    ...
                    if (stack != null && stack.getItem() instanceof IEnergyContainerItem && stack.getItem() != DraconicEvolutionIntegration.arial_capicator) {
    ...
    public int getMaxUpgradePoints(int upgradeIndex) {
        return HellConfig.arialCapacitorMaxUpgradePoints;
    }
