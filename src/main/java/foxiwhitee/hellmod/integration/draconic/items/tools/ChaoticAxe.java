...
public class ChaoticAxe extends CMiningTool implements IInventoryTool, IRenderTweak, ICustomUpgradableItem {
    private String name;
    public ChaoticAxe(Item.ToolMaterial material, String name) {
        super(material);
        this.name = name;
    ...
    public int getCapacity(ItemStack stack) {
        ...
        return HellConfig.chaoticToolsBaseStorage + points * HellConfig.chaoticToolsStoragePerUpgrade;
    }
