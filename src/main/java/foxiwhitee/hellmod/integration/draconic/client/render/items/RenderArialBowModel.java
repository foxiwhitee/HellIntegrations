...
public class RenderArialBowModel implements IItemRenderer {
    ...
    public RenderArialBowModel() {
        for (int i = 0; i < 4; i++)
            this.draconicModels[i] = AdvancedModelLoader.loadModel(DraconicEvolutionIntegration.getResource("models/tools/ArialBow0" + i + ".obj"));
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (this.isDraconic) {
            ...
            DraconicEvolutionIntegration.bindResource("textures/models/tools/ArialBow0" + selection + ".png");
        } else {
