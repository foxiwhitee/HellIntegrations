...
public class RenderChaoticHeart extends Render {
    private static final ResourceLocation texture = new ResourceLocation(HellCore.MODID + ":" + "textures/items/draconic/chaoticHeart.png");
    ...
    private void doRender(EntityChaoticHeart entity, double x, double y, double z, float f) {
...

        {
            ...
            EntityItem itemEntity = new EntityItem(entity.worldObj, 0, 0, 0, new ItemStack(DraconicEvolutionIntegration.chaoticHeart));
