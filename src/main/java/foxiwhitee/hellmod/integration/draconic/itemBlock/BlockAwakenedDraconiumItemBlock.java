...
public class BlockAwakenedDraconiumItemBlock extends ItemBlock implements IEnergyContainerItem {
    protected static int capacity;
    protected static int maxReceive;

    public BlockAwakenedDraconiumItemBlock(Block block) {
        super(block);
        this.setHasSubtypes(true);
    }

    public static void update() {
        capacity = HellConfig.capacityAwake;
        maxReceive = HellConfig.maxReceiveAwake;
    }
