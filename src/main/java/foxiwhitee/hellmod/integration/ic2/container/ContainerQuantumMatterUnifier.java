...
public class ContainerQuantumMatterUnifier extends Container {
    TileQuantumMatterUnifier tile;

    public double energy;

    private int clientProgress;

    public ContainerQuantumMatterUnifier(EntityPlayer inventory, TileQuantumMatterUnifier tile) {
        this.energy = 0.0D;
    ...
    public TileQuantumMatterUnifier getTile() {
        return this.tile;
    }
    ...
    public void updateProgressBar(int id, int val) {
        if ((Minecraft.getMinecraft()).currentScreen instanceof GuiQuantumMatterUnifier)
            ((GuiQuantumMatterUnifier)(Minecraft.getMinecraft()).currentScreen).receiveData(id, val);
    }
