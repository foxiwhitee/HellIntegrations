...
public class ContainerInfinityGenerator extends Container {
    private final TileInfinityGenerator tileentity;
    private int storage = 0;
    private int fuel = 0;
    private int generating;

    public ContainerInfinityGenerator(EntityPlayer inventoryplayer, TileInfinityGenerator tileentitysolarpanel) {
    ...
    public void addCraftingToCrafters(ICrafting icrafting) {
        ...
        icrafting.sendProgressBarUpdate(this, 0, this.tileentity.generating);
        icrafting.sendProgressBarUpdate(this, 1, this.tileentity.storage & '\uffff');
        icrafting.sendProgressBarUpdate(this, 2, this.tileentity.storage >>> 16);
    }
    ...
    public void updateProgressBar(int i, int j) {
        switch (i) {
            case 0: this.tileentity.generating = j; break;
            case 1: this.tileentity.storage = this.tileentity.storage & -65536 | j; break;
            case 2: this.tileentity.storage = this.tileentity.storage & '\uffff' | j << 16; break;
        }
    }
