...
public class GuiCustomSolarPanel  extends GuiContainer {
    public TileCustomSolarPanel tileentity;
    private static ResourceLocation tex = new ResourceLocation(HellCore.MODID, "textures/gui/GUICustomSolarPanel.png");

    public GuiCustomSolarPanel(ContainerCustomSolarPanel container) {
        super(container);
        this.tileentity = (TileCustomSolarPanel) container.getTile();
