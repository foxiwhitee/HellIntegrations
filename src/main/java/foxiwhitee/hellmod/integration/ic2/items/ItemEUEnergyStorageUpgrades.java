...
public class ItemEUEnergyStorageUpgrades extends Item {
    private static final String[] ITEMS = new String[] {"energyStorageUpgrade1", "energyStorageUpgrade2", "energyStorageUpgrade3"};
    IIcon[] icons;

    public ItemEUEnergyStorageUpgrades(String name) {
