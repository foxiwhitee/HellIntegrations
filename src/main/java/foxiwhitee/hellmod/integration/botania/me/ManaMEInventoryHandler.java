...
public class ManaMEInventoryHandler<T extends IAEStack<T>> implements IMEInventoryHandler<T> {
    ...
    public ManaMEInventoryHandler(IMEInventory<T> i, StorageChannel channel) {
        this.internal = i instanceof IMEInventoryHandler ? (IMEInventoryHandler<T>) i : new ManaMEPassThrough<>(i, channel);
        this.myPriority = 0;
