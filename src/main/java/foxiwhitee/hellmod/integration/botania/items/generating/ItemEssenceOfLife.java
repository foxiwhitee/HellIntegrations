...
public class ItemEssenceOfLife extends Item implements IItemWithEffect {
    ...
    public ItemEssenceOfLife(String name) {
        this.name = name;
    ...
    public PartTypes getType() {
        return PartTypes.EssenceOfLife;
    }
    ...
    public void registerIcons(IIconRegister register) {
        ...
        for (int i = 0; i < icons.length; i++) {
            this.icons[i] = register.registerIcon(HellCore.MODID + ":botania/essence/" + name + items[i]);
        }
    }
