...
public class GuiManaGenerator extends AEBaseGui {
    ContainerManaGenerator container;

    public GuiManaGenerator(ContainerManaGenerator container) {
        super(container);
    ...
    private ResourceLocation getTexture() {
        return new ResourceLocation(HellCore.MODID, "textures/gui/gui_mana_generator_" + container.getTile().getLevel() + ".png");
    }
