...
public class PartHybridInterface extends PartBasicState implements IGridTickable, IStorageMonitorable, IInventoryDestination, IInterfaceHost, ISidedInventory, IAEAppEngInventory, ITileStorageMonitorable, IPriorityHost {
    ...
    private final CustomHybridDualityInterface duality = new CustomHybridDualityInterface(this.getProxy(), this);
    ...
    protected ItemStack getItemFromTile(Object obj) {
        return new ItemStack(ModItems.ITEM_PARTS, 1, 1);
    }
    ...
    @Override
    public CustomHybridDualityInterface getInterfaceDuality() {
        return this.duality;
    }
    ...
    public IInterfaceTerminalSupport.PatternsConfiguration[] getPatternsConfigurations() {
        return new IInterfaceTerminalSupport.PatternsConfiguration[] { new IInterfaceTerminalSupport.PatternsConfiguration(0, 9), new IInterfaceTerminalSupport.PatternsConfiguration(9, 9), new IInterfaceTerminalSupport.PatternsConfiguration(18, 9) };
    }
