...
public class PartAdvancedInterface extends PartBasicState implements IGridTickable, IStorageMonitorable, IInventoryDestination, IInterfaceHost, ISidedInventory, IAEAppEngInventory, ITileStorageMonitorable, IPriorityHost {

    private final CustomAdvancedDualityInterface duality = new CustomAdvancedDualityInterface(this.getProxy(), this);

    public PartAdvancedInterface(ItemStack is) {
        super(is);

    }

    protected ItemStack getItemFromTile(Object obj) {
        return new ItemStack(ModItems.ITEM_PARTS, 1, 0);
    }
    ...
    public void renderInventory(final IPartRenderHelper rh, final RenderBlocks renderer) {
        rh.setTexture(CableBusTextures.PartMonitorSides.getIcon(),
                ...
                CommonProxy.getPartAdvInterfaceFront().getIcon(),
                CableBusTextures.PartMonitorSides.getIcon(),
                CableBusTextures.PartMonitorSides.getIcon());
    ...
    public boolean onPartActivate(final EntityPlayer p, final Vec3 pos) {
        ...
        if (Platform.isServer()) {
            Platform.openGUI(p, this.getTileEntity(), this.getSide(), CommonProxy.getGuiAdvInterface());
        }
    ...
    @Override
    public CustomAdvancedDualityInterface getInterfaceDuality() {
        return this.duality;
    }
    ...
    public IInterfaceTerminalSupport.PatternsConfiguration[] getPatternsConfigurations() {
        return new IInterfaceTerminalSupport.PatternsConfiguration[] { new IInterfaceTerminalSupport.PatternsConfiguration(0, 9), new IInterfaceTerminalSupport.PatternsConfiguration(9, 9) };
    }
