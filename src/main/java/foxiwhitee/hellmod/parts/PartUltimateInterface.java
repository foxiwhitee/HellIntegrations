...
public class PartUltimateInterface extends PartBasicState implements IGridTickable, IStorageMonitorable, IInventoryDestination, IInterfaceHost, ISidedInventory, IAEAppEngInventory, ITileStorageMonitorable, IPriorityHost {

    private final CustomUltimateDualityInterface duality = new CustomUltimateDualityInterface(this.getProxy(), this);

    public PartUltimateInterface(ItemStack is) {
        super(is);

    }

    protected ItemStack getItemFromTile(Object obj) {
        return new ItemStack(ModItems.ITEM_PARTS, 1, 2);
    }
    ...
    public void renderInventory(final IPartRenderHelper rh, final RenderBlocks renderer) {
        rh.setTexture(CableBusTextures.PartMonitorSides.getIcon(),
                ...
                CommonProxy.getPartUltimateInterfaceFront().getIcon(),
                CableBusTextures.PartMonitorSides.getIcon(),
                CableBusTextures.PartMonitorSides.getIcon());
    ...
    public boolean onPartActivate(final EntityPlayer p, final Vec3 pos) {
        ...
        if (Platform.isServer()) {
            Platform.openGUI(p, this.getTileEntity(), this.getSide(), CommonProxy.getGuiUltimateInterface());
        }
    ...
    @Override
    public CustomUltimateDualityInterface getInterfaceDuality() {
        return this.duality;
    }
